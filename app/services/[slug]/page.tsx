...
export default async function ServiceDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <section className="section shell"><div className="split-section"><div><SectionHeading eyebrow="Project Proof" title={`See ${service.shortTitle.toLowerCase()} work up close`} text="Approved customer photos connected to this service will appear here when the final catalog arrives." /><Link className="text-link" href="/projects">View the project catalog <span aria-hidden="true">→</span></Link></div><ProjectPlaceholder compact /></div></section>
