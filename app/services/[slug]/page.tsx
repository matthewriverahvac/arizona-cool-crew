...
export default async function ServiceDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <section className="section shell"><div className="split-section service-proof"><div><SectionHeading eyebrow="Real Project Proof" title="See the work before and after" text="Compare the original rooftop system with the completed Cool Fox replacement. Both photos come from the same customer project." /><Link className="text-link" href="/projects">View the project catalog <span aria-hidden="true">→</span></Link></div><BeforeAfterFeature compact /></div></section>
